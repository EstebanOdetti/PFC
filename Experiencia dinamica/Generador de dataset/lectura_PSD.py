...
directory_path = "C:/Users/Usuario/OneDrive/no aprobadas-andres/PFC/Informe de avance 3/experiencias/PSD todas"
...
for file in files:
    ...
    with open(file, 'r') as f:
        lines = f.readlines()
        for line in lines:
            # Separa la línea en columnas usando el espacio como separador
